        ...
        <div ref={ref} className="flex w-full justify-center items-center min-h-[70vh] max-sm:py-10 bg-gradient-to-b from-[#494641] to-[#bbb5aa] text-white">
            <div className='flex flex-col w-full max-w-7xl mx-10'>
                <div className='max-w-[750px] flex flex-col mb-10'>
                    <span>{t('wallet_heading1')}</span>
                    <span className='text-5xl font-bold mt-3'>{t('wallet_heading2')}</span>
                    <span className='mt-5'>{t('wallet_description')}</span>
                </div>
                <div className='w-full flex flex-wrap'>
                    {[
                        { icon: Wallet, title: t('wallet_feature1_title'), description: t('wallet_feature1_description') },
                        { icon: ChartBar, title: t('wallet_feature2_title'), description: t('wallet_feature2_description') },
                        { icon: Shield, title: t('wallet_feature3_title'), description: t('wallet_feature3_description') }
                    ].map((item, index) => (
